...
enum tips_adj_reason_flags_bf
{
    ...
    TIPS_FLAG_MAN_TIME_UPDATE_BIT = COMMON_BIT(TIPS_FLAG_MAN_TIME_UPDATE_POS),

    TIPS_FLAG_EXT_TIME_UPDATE_POS = 1,
    TIPS_FLAG_EXT_TIME_UPDATE_BIT = COMMON_BIT(TIPS_FLAG_EXT_TIME_UPDATE_POS),

    TIPS_FLAG_CHG_TIME_ZONE_POS = 2,
    TIPS_FLAG_CHG_TIME_ZONE_BIT = COMMON_BIT(TIPS_FLAG_CHG_TIME_ZONE_POS),

    TIPS_FLAG_DST_CHANGE_POS = 3,
    TIPS_FLAG_DST_CHANGE_BIT = COMMON_BIT(TIPS_FLAG_DST_CHANGE_POS),
};
