...
#define CPP_CP_MEAS_ADV_MAX_LEN           (CPP_CP_MEAS_MAX_LEN + CPP_CP_ADV_HEADER_LEN)
/// CP Measurement Value Min Length
...
#define CPP_MAX_MANF_DATA_LEN             (13)
...
/// CPP CT Point timeout (in milliseconds)
#define CPP_CP_TIMEOUT                    (30000)
...
enum cpp_meas_flags_bf
{
    ...
    CPP_MEAS_PEDAL_POWER_BALANCE_PRESENT_BIT        = COMMON_BIT(CPP_MEAS_PEDAL_POWER_BALANCE_PRESENT_POS),

    /// Pedal Power Balance Reference
    CPP_MEAS_PEDAL_POWER_BALANCE_REFERENCE_POS      = 1,
    CPP_MEAS_PEDAL_POWER_BALANCE_REFERENCE_BIT      = COMMON_BIT(CPP_MEAS_PEDAL_POWER_BALANCE_REFERENCE_POS),

    /// Accumulated Torque Present
    CPP_MEAS_ACCUM_TORQUE_PRESENT_POS               = 2,
    CPP_MEAS_ACCUM_TORQUE_PRESENT_BIT               = COMMON_BIT(CPP_MEAS_ACCUM_TORQUE_PRESENT_POS),

    /// Accumulated Torque Source
    CPP_MEAS_ACCUM_TORQUE_SOURCE_POS                = 3,
    CPP_MEAS_ACCUM_TORQUE_SOURCE_BIT                = COMMON_BIT(CPP_MEAS_ACCUM_TORQUE_SOURCE_POS),

    /// Wheel Revolution Data Present
    CPP_MEAS_WHEEL_REV_DATA_PRESENT_POS             = 4,
    CPP_MEAS_WHEEL_REV_DATA_PRESENT_BIT             = COMMON_BIT(CPP_MEAS_WHEEL_REV_DATA_PRESENT_POS),

    /// Crank Revolution Data Present
    CPP_MEAS_CRANK_REV_DATA_PRESENT_POS             = 5,
    CPP_MEAS_CRANK_REV_DATA_PRESENT_BIT             = COMMON_BIT(CPP_MEAS_CRANK_REV_DATA_PRESENT_POS),

    /// Extreme Force Magnitudes Present
    CPP_MEAS_EXTREME_FORCE_MAGNITUDES_PRESENT_POS   = 6,
    CPP_MEAS_EXTREME_FORCE_MAGNITUDES_PRESENT_BIT   = COMMON_BIT(CPP_MEAS_EXTREME_FORCE_MAGNITUDES_PRESENT_POS),

    /// Extreme Torque Magnitudes Present
    CPP_MEAS_EXTREME_TORQUE_MAGNITUDES_PRESENT_POS  = 7,
    CPP_MEAS_EXTREME_TORQUE_MAGNITUDES_PRESENT_BIT  = COMMON_BIT(CPP_MEAS_EXTREME_TORQUE_MAGNITUDES_PRESENT_POS),

    /// Extreme Angles Present
    CPP_MEAS_EXTREME_ANGLES_PRESENT_POS             = 8,
    CPP_MEAS_EXTREME_ANGLES_PRESENT_BIT             = COMMON_BIT(CPP_MEAS_EXTREME_ANGLES_PRESENT_POS),

    /// Top Dead Spot Angle Present
    CPP_MEAS_TOP_DEAD_SPOT_ANGLE_PRESENT_POS        = 9,
    CPP_MEAS_TOP_DEAD_SPOT_ANGLE_PRESENT_BIT        = COMMON_BIT(CPP_MEAS_TOP_DEAD_SPOT_ANGLE_PRESENT_POS),

    /// Bottom Dead Spot Angle Present
    CPP_MEAS_BOTTOM_DEAD_SPOT_ANGLE_PRESENT_POS     = 10,
    CPP_MEAS_BOTTOM_DEAD_SPOT_ANGLE_PRESENT_BIT     = COMMON_BIT(CPP_MEAS_BOTTOM_DEAD_SPOT_ANGLE_PRESENT_POS),

    /// Accumulated Energy Present
    CPP_MEAS_ACCUM_ENERGY_PRESENT_POS               = 11,
    CPP_MEAS_ACCUM_ENERGY_PRESENT_BIT               = COMMON_BIT(CPP_MEAS_ACCUM_ENERGY_PRESENT_POS),

    /// Offset Compensation Indicator
    CPP_MEAS_OFFSET_COMPENSATION_INDICATOR_POS      = 12,
    CPP_MEAS_OFFSET_COMPENSATION_INDICATOR_BIT      = COMMON_BIT(CPP_MEAS_OFFSET_COMPENSATION_INDICATOR_POS),
...
enum cpp_feat_flags_bf
{
    ...
    CPP_FEAT_PEDAL_POWER_BALANCE_SUP_BIT                = COMMON_BIT(CPP_FEAT_PEDAL_POWER_BALANCE_SUP_POS),

    /// Accumulated Torque Supported
    CPP_FEAT_ACCUM_TORQUE_SUP_POS                       = 1,
    CPP_FEAT_ACCUM_TORQUE_SUP_BIT                       = COMMON_BIT(CPP_FEAT_ACCUM_TORQUE_SUP_POS),

    /// Wheel Revolution Data Supported
    CPP_FEAT_WHEEL_REV_DATA_SUP_POS                     = 2,
    CPP_FEAT_WHEEL_REV_DATA_SUP_BIT                     = COMMON_BIT(CPP_FEAT_WHEEL_REV_DATA_SUP_POS),

    /// Crank Revolution Data Supported
    CPP_FEAT_CRANK_REV_DATA_SUP_POS                     = 3,
    CPP_FEAT_CRANK_REV_DATA_SUP_BIT                     = COMMON_BIT(CPP_FEAT_CRANK_REV_DATA_SUP_POS),

    /// Extreme Magnitudes Supported
    CPP_FEAT_EXTREME_MAGNITUDES_SUP_POS                 = 4,
    CPP_FEAT_EXTREME_MAGNITUDES_SUP_BIT                 = COMMON_BIT(CPP_FEAT_EXTREME_MAGNITUDES_SUP_POS),

    /// Extreme Angles Supported
    CPP_FEAT_EXTREME_ANGLES_SUP_POS                     = 5,
    CPP_FEAT_EXTREME_ANGLES_SUP_BIT                     = COMMON_BIT(CPP_FEAT_EXTREME_ANGLES_SUP_POS),

    /// Top and Bottom Dead Spot Angles Supported
    CPP_FEAT_TOPBOT_DEAD_SPOT_ANGLES_SUP_POS            = 6,
    CPP_FEAT_TOPBOT_DEAD_SPOT_ANGLES_SUP_BIT            = COMMON_BIT(CPP_FEAT_TOPBOT_DEAD_SPOT_ANGLES_SUP_POS),

    /// Accumulated Energy Supported
    CPP_FEAT_ACCUM_ENERGY_SUP_POS                       = 7,
    CPP_FEAT_ACCUM_ENERGY_SUP_BIT                       = COMMON_BIT(CPP_FEAT_ACCUM_ENERGY_SUP_POS),

    /// Offset Compensation Indicator Supported
    CPP_FEAT_OFFSET_COMP_IND_SUP_POS                    = 8,
    CPP_FEAT_OFFSET_COMP_IND_SUP_BIT                    = COMMON_BIT(CPP_FEAT_OFFSET_COMP_IND_SUP_POS),

    /// Offset Compensation Supported
    CPP_FEAT_OFFSET_COMP_SUP_POS                        = 9,
    CPP_FEAT_OFFSET_COMP_SUP_BIT                        = COMMON_BIT(CPP_FEAT_OFFSET_COMP_SUP_POS),

    /// CP Measurement CH Content Masking Supported
    CPP_FEAT_CP_MEAS_CH_CONTENT_MASKING_SUP_POS         = 10,
    CPP_FEAT_CP_MEAS_CH_CONTENT_MASKING_SUP_BIT         = COMMON_BIT(CPP_FEAT_CP_MEAS_CH_CONTENT_MASKING_SUP_POS),

    /// Multiple Sensor Locations Supported
    CPP_FEAT_MULT_SENSOR_LOC_SUP_POS                    = 11,
    CPP_FEAT_MULT_SENSOR_LOC_SUP_BIT                    = COMMON_BIT(CPP_FEAT_MULT_SENSOR_LOC_SUP_POS),

    /// Crank Length Adjustment Supported
    CPP_FEAT_CRANK_LENGTH_ADJ_SUP_POS                   = 12,
    CPP_FEAT_CRANK_LENGTH_ADJ_SUP_BIT                   = COMMON_BIT(CPP_FEAT_CRANK_LENGTH_ADJ_SUP_POS),

    /// Chain Length Adjustment Supported
    CPP_FEAT_CHAIN_LENGTH_ADJ_SUP_POS                   = 13,
    CPP_FEAT_CHAIN_LENGTH_ADJ_SUP_BIT                   = COMMON_BIT(CPP_FEAT_CHAIN_LENGTH_ADJ_SUP_POS),

    /// Chain Weight Adjustment Supported
    CPP_FEAT_CHAIN_WEIGHT_ADJ_SUP_POS                   = 14,
    CPP_FEAT_CHAIN_WEIGHT_ADJ_SUP_BIT                   = COMMON_BIT(CPP_FEAT_CHAIN_WEIGHT_ADJ_SUP_POS),

    /// Span Length Adjustment Supported
    CPP_FEAT_SPAN_LENGTH_ADJ_SUP_POS                    = 15,
    CPP_FEAT_SPAN_LENGTH_ADJ_SUP_BIT                    = COMMON_BIT(CPP_FEAT_SPAN_LENGTH_ADJ_SUP_POS),

    /// Sensor Measurement Context
    CPP_FEAT_SENSOR_MEAS_CONTEXT_POS                    = 16,
    CPP_FEAT_SENSOR_MEAS_CONTEXT_BIT                    = COMMON_BIT(CPP_FEAT_SENSOR_MEAS_CONTEXT_POS),

    /// Instantaneous Measurement Direction Supported
    CPP_FEAT_INSTANT_MEAS_DIRECTION_SUP_POS             = 17,
    CPP_FEAT_INSTANT_MEAS_DIRECTION_SUP_BIT             = COMMON_BIT(CPP_FEAT_INSTANT_MEAS_DIRECTION_SUP_POS),

    /// Factory Calibration Date Supported
    CPP_FEAT_FACTORY_CALIBRATION_DATE_SUP_POS           = 18,
    CPP_FEAT_FACTORY_CALIBRATION_DATE_SUP_BIT           = COMMON_BIT(CPP_FEAT_FACTORY_CALIBRATION_DATE_SUP_POS),

    /// Enhanced Offset Compensation Supported
    CPP_FEAT_ENHANCED_OFFSET_COMPENS_SUP_POS            = 19,
    CPP_FEAT_ENHANCED_OFFSET_COMPENS_SUP_BIT            = COMMON_BIT(CPP_FEAT_ENHANCED_OFFSET_COMPENS_SUP_POS),

    /// Distribute System Supported LSB
    CPP_FEAT_FACTORY_CALIBRATION_DATE_SUP_LSB_POS       = 20,
    CPP_FEAT_FACTORY_CALIBRATION_DATE_SUP_LSB_BIT       = COMMON_BIT(CPP_FEAT_FACTORY_CALIBRATION_DATE_SUP_LSB_POS),

    /// Distribute System Supported MSB
    CPP_FEAT_FACTORY_CALIBRATION_DATE_SUP_MSB_POS       = 21,
    CPP_FEAT_FACTORY_CALIBRATION_DATE_SUP_MSB_BIT       = COMMON_BIT(CPP_FEAT_FACTORY_CALIBRATION_DATE_SUP_MSB_POS),
...
enum cpp_vector_flags_bf
{
    ...
    CPP_VECTOR_CRANK_REV_DATA_PRESENT_BIT               = COMMON_BIT(CPP_VECTOR_CRANK_REV_DATA_PRESENT_POS),

    /// First Crank Measurement Angle Present
    CPP_VECTOR_FIRST_CRANK_MEAS_ANGLE_PRESENT_POS       = 1,
    CPP_VECTOR_FIRST_CRANK_MEAS_ANGLE_PRESENT_BIT       = COMMON_BIT(CPP_VECTOR_FIRST_CRANK_MEAS_ANGLE_PRESENT_POS),

    /// Instantaneous Force Magnitude Array Present
    CPP_VECTOR_INST_FORCE_MAGNITUDE_ARRAY_PRESENT_POS   = 2,
    CPP_VECTOR_INST_FORCE_MAGNITUDE_ARRAY_PRESENT_BIT   = COMMON_BIT(CPP_VECTOR_INST_FORCE_MAGNITUDE_ARRAY_PRESENT_POS),

    /// Instantaneous Torque Magnitude Array Present
    CPP_VECTOR_INST_TORQUE_MAGNITUDE_ARRAY_PRESENT_POS  = 3,
    CPP_VECTOR_INST_TORQUE_MAGNITUDE_ARRAY_PRESENT_BIT  = COMMON_BIT(CPP_VECTOR_INST_TORQUE_MAGNITUDE_ARRAY_PRESENT_POS),

    /// Instantaneous Measurement Direction LSB
    CPP_VECTOR_INST_MEAS_DIRECTION_LSB_POS              = 4,
    CPP_VECTOR_INST_MEAS_DIRECTION_LSB_BIT              = COMMON_BIT(CPP_VECTOR_INST_MEAS_DIRECTION_LSB_POS),

    /// Instantaneous Measurement Direction MSB
    CPP_VECTOR_INST_MEAS_DIRECTION_MSB_POS              = 5,
    CPP_VECTOR_INST_MEAS_DIRECTION_MSB_BIT              = COMMON_BIT(CPP_VECTOR_INST_MEAS_DIRECTION_MSB_POS),
...
/// CP Measurement
typedef struct cpp_cp_meas_ind
{
    /// Flags
    uint16_t flags;
    /// Instantaneous Power
...
typedef struct cpp_enhanced_offset_comp
{
    /// Offset
    int16_t  comp_offset;
    ...
    uint8_t  data[CPP_MAX_MANF_DATA_LEN];
} cpp_enhanced_offset_comp_t;

/// CP Vector
typedef struct cpp_cp_vector
{
    /// Flags
    uint8_t  flags;
    ...
    int16_t  force_torque_magnitude[CPP_MAX_TORQUE_NB];
} cpp_cp_vector_t;
...
union cpp_ctnl_pt_rsp_val
{
    ...
    /// Enhanced Offset Compensation
    cpp_enhanced_offset_comp_t enhanced_offset_comp;
    /// Calibration date
