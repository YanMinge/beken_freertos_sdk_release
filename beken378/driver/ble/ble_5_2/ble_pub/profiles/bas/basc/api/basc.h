 ...
 *
 * Wait for @see cb_read_batt_level_cmp execution before starting a new procedure
 *
 * @param[in] conidx        Connection index
 * @param[in] bas_instance  Battery Service Instance - From 0 to BASC_NB_BAS_INSTANCES_MAX-1
 ****************************************************************************************
 ...
 *
 * Wait for @see cb_read_ntf_cfg_cmp execution before starting a new procedure
 *
 * @param[in] conidx        Connection index
 * @param[in] bas_instance  Battery Service Instance - From 0 to BASC_NB_BAS_INSTANCES_MAX-1
 ****************************************************************************************
 ...
 *
 * Wait for @see cb_read_pres_format_cmp execution before starting a new procedure
 *
 * @param[in] conidx        Connection index
 * @param[in] bas_instance  Battery Service Instance - From 0 to BASC_NB_BAS_INSTANCES_MAX-1
 ****************************************************************************************
 ...
 *
 * Wait for @see cb_write_ntf_cfg_cmp execution before starting a new procedure
 *
 * @param[in] conidx        Connection index
 * @param[in] bas_instance  Battery Service Instance - From 0 to BASC_NB_BAS_INSTANCES_MAX-1
 * @param[in] ntf_cfg       Notification Configuration
