...
enum glp_meas_flag_bf
{
    ...
    GLP_MEAS_TIME_OFF_PRES_BIT                  = COMMON_BIT(GLP_MEAS_TIME_OFF_PRES_POS),
    ...
    GLP_MEAS_GL_CTR_TYPE_AND_SPL_LOC_PRES_BIT   = COMMON_BIT(GLP_MEAS_GL_CTR_TYPE_AND_SPL_LOC_PRES_POS),

    /// Glucose Concentration Units
    /// 0 for kg/L; 1 for mol/L
    GLP_MEAS_GL_CTR_UNITS_POS                   = 2,
    GLP_MEAS_GL_CTR_UNITS_BIT                   = COMMON_BIT(GLP_MEAS_GL_CTR_UNITS_POS),

    /// Sensor Status Annunciation Present Bit
    /// Sensor Status Annunciation Present
    GLP_MEAS_SENS_STAT_ANNUN_PRES_POS           = 3,
    GLP_MEAS_SENS_STAT_ANNUN_PRES_BIT           = COMMON_BIT(GLP_MEAS_SENS_STAT_ANNUN_PRES_POS),

    /// Context Information Follow Bit
    /// Context Information Follows
    GLP_MEAS_CTX_INF_FOLW_POS                   = 4,
    GLP_MEAS_CTX_INF_FOLW_BIT                   = COMMON_BIT(GLP_MEAS_CTX_INF_FOLW_POS),
...
enum glp_meas_ctx_flag_bf
{
    ...
    GLP_CTX_CRBH_ID_AND_CRBH_PRES_BIT       = COMMON_BIT(GLP_CTX_CRBH_ID_AND_CRBH_PRES_POS),

    /// Meal Present Bit
    /// Meal Present
    GLP_CTX_MEAL_PRES_POS                   = 1,
    GLP_CTX_MEAL_PRES_BIT                   = COMMON_BIT(GLP_CTX_MEAL_PRES_POS),

    /// Tester-Health Present Bit
    /// Tester-Health Present
    GLP_CTX_TESTER_HEALTH_PRES_POS          = 2,
    GLP_CTX_TESTER_HEALTH_PRES_BIT          = COMMON_BIT(GLP_CTX_TESTER_HEALTH_PRES_POS),
    ...
    GLP_CTX_EXE_DUR_AND_EXE_INTENS_PRES_BIT = COMMON_BIT(GLP_CTX_EXE_DUR_AND_EXE_INTENS_PRES_POS),

    /// Medication ID And Medication Present Bit
    /// Medication ID And Medication Present
    GLP_CTX_MEDIC_ID_AND_MEDIC_PRES_POS     = 4,
    GLP_CTX_MEDIC_ID_AND_MEDIC_PRES_BIT     = COMMON_BIT(GLP_CTX_MEDIC_ID_AND_MEDIC_PRES_POS),

    /// Medication Value Units
    /// 0 for kilograms; 1 for liters
    GLP_CTX_MEDIC_VAL_UNITS_POS             = 5,
    GLP_CTX_MEDIC_VAL_UNITS_BIT             = COMMON_BIT(GLP_CTX_MEDIC_VAL_UNITS_POS),

    /// HbA1c Present Bit
    /// HbA1c Present
    GLP_CTX_HBA1C_PRES_POS                  = 6,
    GLP_CTX_HBA1C_PRES_BIT                  = COMMON_BIT(GLP_CTX_HBA1C_PRES_POS),

    /// Extended Flags Present Bit
    /// Extended Flags Present
    GLP_CTX_EXTD_F_PRES_POS                 = 7,
    GLP_CTX_EXTD_F_PRES_BIT                 = COMMON_BIT(GLP_CTX_EXTD_F_PRES_POS),
};
...
enum glp_srv_feature_flag
{
    ...
    GLP_FET_LOW_BAT_DET_DUR_MEAS_SUPP_BIT       = COMMON_BIT(GLP_FET_LOW_BAT_DET_DUR_MEAS_SUPP_POS),

    /// Sensor Malfunction Detection Support Bit
    /// Sensor Malfunction Detection Supported
    GLP_FET_SENS_MFNC_DET_SUPP_POS              = 1,
    GLP_FET_SENS_MFNC_DET_SUPP_BIT              = COMMON_BIT(GLP_FET_SENS_MFNC_DET_SUPP_POS),

    /// Sensor Sample Size Support Bit
    /// Sensor Sample Size Supported
    GLP_FET_SENS_SPL_SIZE_SUPP_POS              = 2,
    GLP_FET_SENS_SPL_SIZE_SUPP_BIT              = COMMON_BIT(GLP_FET_SENS_SPL_SIZE_SUPP_POS),
    ...
    GLP_FET_SENS_STRIP_INSERT_ERR_DET_SUPP_BIT  = COMMON_BIT(GLP_FET_SENS_STRIP_INSERT_ERR_DET_SUPP_POS),
    ...
    GLP_FET_SENS_STRIP_TYPE_ERR_DET_SUPP_BIT    = COMMON_BIT(GLP_FET_SENS_STRIP_TYPE_ERR_DET_SUPP_POS),
    ...
    GLP_FET_SENS_RES_HIGH_LOW_DET_SUPP_BIT      = COMMON_BIT(GLP_FET_SENS_RES_HIGH_LOW_DET_SUPP_POS),
    ...
    GLP_FET_SENS_TEMP_HIGH_LOW_DET_SUPP_BIT     = COMMON_BIT(GLP_FET_SENS_TEMP_HIGH_LOW_DET_SUPP_POS),

    /// Sensor Read Interrupt Detection Support Bit
    /// Sensor Read Interrupt Detection Supported
    GLP_FET_SENS_RD_INT_DET_SUPP_POS            = 7,
    GLP_FET_SENS_RD_INT_DET_SUPP_BIT            = COMMON_BIT(GLP_FET_SENS_RD_INT_DET_SUPP_POS),

    /// General Device Fault Support Bit
    /// General Device Fault Supported
    GLP_FET_GEN_DEV_FLT_SUPP_POS                = 8,
    GLP_FET_GEN_DEV_FLT_SUPP_BIT                = COMMON_BIT(GLP_FET_GEN_DEV_FLT_SUPP_POS),

    /// Time Fault Support Bit
    /// Time Fault Supported
    GLP_FET_TIME_FLT_SUPP_POS                   = 9,
    GLP_FET_TIME_FLT_SUPP_BIT                   = COMMON_BIT(GLP_FET_TIME_FLT_SUPP_POS),

    /// Multiple Bond Support Bit
    /// Multiple Bond Supported
    GLP_FET_MUL_BOND_SUPP_POS                   = 10,
    GLP_FET_MUL_BOND_SUPP_BIT                   = COMMON_BIT(GLP_FET_MUL_BOND_SUPP_POS),
