...
enum pasp_alert_status_bf
{
    ...
    PASP_RINGER_STATE_BIT = COMMON_BIT(PASP_RINGER_STATE_POS),

    /// Vibrate State
    /// 0 not active and 1 active
    PASP_VIBRATE_STATE_POS = 1,
    PASP_VIBRATE_STATE_BIT = COMMON_BIT(PASP_VIBRATE_STATE_POS),

    /// Display Alert State
    /// 0 not active and 1 active
    PASP_DISP_ALERT_STATE_POS = 2,
    PASP_DISP_ALERT_STATE_BIT = COMMON_BIT(PASP_DISP_ALERT_STATE_POS),
};
