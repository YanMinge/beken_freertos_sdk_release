...
enum cscp_meas_flags_bf
{
    ...
    CSCP_MEAS_WHEEL_REV_DATA_PRESENT_BIT = COMMON_BIT(CSCP_MEAS_WHEEL_REV_DATA_PRESENT_POS),

    /// Crank Revolution Data Present
    CSCP_MEAS_CRANK_REV_DATA_PRESENT_POS = 1,
    CSCP_MEAS_CRANK_REV_DATA_PRESENT_BIT = COMMON_BIT(CSCP_MEAS_CRANK_REV_DATA_PRESENT_POS),
};
...
enum cscp_feat_flags_bf
{
    ...
    CSCP_FEAT_WHEEL_REV_DATA_SUPP_BIT = COMMON_BIT(CSCP_FEAT_WHEEL_REV_DATA_SUPP_POS),

    /// Crank Revolution Data Supported
    CSCP_FEAT_CRANK_REV_DATA_SUPP_POS = 1,
    CSCP_FEAT_CRANK_REV_DATA_SUPP_BIT = COMMON_BIT(CSCP_FEAT_CRANK_REV_DATA_SUPP_POS),

    /// Multiple Sensor Location Supported
    CSCP_FEAT_MULT_SENSOR_LOC_SUPP_POS = 2,
    CSCP_FEAT_MULT_SENSOR_LOC_SUPP_BIT = COMMON_BIT(CSCP_FEAT_MULT_SENSOR_LOC_SUPP_POS),
};
