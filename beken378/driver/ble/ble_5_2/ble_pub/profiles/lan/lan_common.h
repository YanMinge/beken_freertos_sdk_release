...
enum lanp_feat_flags
{
    ...
    LANP_FEAT_INSTANTANEOUS_SPEED_SUP_BIT           = COMMON_BIT(LANP_FEAT_INSTANTANEOUS_SPEED_SUP_POS),

    /// Total Distance Supported
    LANP_FEAT_TOTAL_DISTANCE_SUP_POS                = 1,
    LANP_FEAT_TOTAL_DISTANCE_SUP_BIT                = COMMON_BIT(LANP_FEAT_TOTAL_DISTANCE_SUP_POS),

    /// Location Supported
    LANP_FEAT_LOCATION_SUP_POS                      = 2,
    LANP_FEAT_LOCATION_SUP_BIT                      = COMMON_BIT(LANP_FEAT_LOCATION_SUP_POS),

    /// Elevation Supported
    LANP_FEAT_ELEVATION_SUP_POS                     = 3,
    LANP_FEAT_ELEVATION_SUP_BIT                     = COMMON_BIT(LANP_FEAT_ELEVATION_SUP_POS),

    /// Heading Supported
    LANP_FEAT_HEADING_SUP_POS                       = 4,
    LANP_FEAT_HEADING_SUP_BIT                       = COMMON_BIT(LANP_FEAT_HEADING_SUP_POS),

    /// Rolling Time Supported
    LANP_FEAT_ROLLING_TIME_SUP_POS                  = 5,
    LANP_FEAT_ROLLING_TIME_SUP_BIT                  = COMMON_BIT(LANP_FEAT_ROLLING_TIME_SUP_POS),

    /// UTC Time Supported
    LANP_FEAT_UTC_TIME_SUP_POS                      = 6,
    LANP_FEAT_UTC_TIME_SUP_BIT                      = COMMON_BIT(LANP_FEAT_UTC_TIME_SUP_POS),

    /// Remaining Distance Supported
    LANP_FEAT_REMAINING_DISTANCE_SUP_POS            = 7,
    LANP_FEAT_REMAINING_DISTANCE_SUP_BIT            = COMMON_BIT(LANP_FEAT_REMAINING_DISTANCE_SUP_POS),

    /// Remaining Vertical Distance Supported
    LANP_FEAT_REMAINING_VERTICAL_DISTANCE_SUP_POS   = 8,
    LANP_FEAT_REMAINING_VERTICAL_DISTANCE_SUP_BIT   = COMMON_BIT(LANP_FEAT_REMAINING_VERTICAL_DISTANCE_SUP_POS),

    /// Estimated Time of Arrival Supported
    LANP_FEAT_ESTIMATED_TIME_OF_ARRIVAL_SUP_POS     = 9,
    LANP_FEAT_ESTIMATED_TIME_OF_ARRIVAL_SUP_BIT     = COMMON_BIT(LANP_FEAT_ESTIMATED_TIME_OF_ARRIVAL_SUP_POS),

    /// Number of Beacons in Solution Supported
    LANP_FEAT_NUMBER_OF_BEACONS_IN_SOLUTION_SUP_POS = 10,
    LANP_FEAT_NUMBER_OF_BEACONS_IN_SOLUTION_SUP_BIT = COMMON_BIT(LANP_FEAT_NUMBER_OF_BEACONS_IN_SOLUTION_SUP_POS),

    /// Number of Beacons in View Supported
    LANP_FEAT_NUMBER_OF_BEACONS_IN_VIEW_SUP_POS     = 11,
    LANP_FEAT_NUMBER_OF_BEACONS_IN_VIEW_SUP_BIT     = COMMON_BIT(LANP_FEAT_NUMBER_OF_BEACONS_IN_VIEW_SUP_POS),

    /// Time to First Fix Supported
    LANP_FEAT_TIME_TO_FIRST_FIX_SUP_POS             = 12,
    LANP_FEAT_TIME_TO_FIRST_FIX_SUP_BIT             = COMMON_BIT(LANP_FEAT_TIME_TO_FIRST_FIX_SUP_POS),

    /// Estimated Horizontal Position Error Supported
    LANP_FEAT_ESTIMATED_HOR_POSITION_ERROR_SUP_POS  = 13,
    LANP_FEAT_ESTIMATED_HOR_POSITION_ERROR_SUP_BIT  = COMMON_BIT(LANP_FEAT_ESTIMATED_HOR_POSITION_ERROR_SUP_POS),

    /// Estimated Vertical Position Error Supported
    LANP_FEAT_ESTIMATED_VER_POSITION_ERROR_SUP_POS  = 14,
    LANP_FEAT_ESTIMATED_VER_POSITION_ERROR_SUP_BIT  = COMMON_BIT(LANP_FEAT_ESTIMATED_VER_POSITION_ERROR_SUP_POS),

    /// Horizontal Dilution of Precision Supported
    LANP_FEAT_HOR_DILUTION_OF_PRECISION_SUP_POS     = 15,
    LANP_FEAT_HOR_DILUTION_OF_PRECISION_SUP_BIT     = COMMON_BIT(LANP_FEAT_HOR_DILUTION_OF_PRECISION_SUP_POS),

    /// Vertical Dilution of Precision Supported
    LANP_FEAT_VER_DILUTION_OF_PRECISION_SUP_POS     = 16,
    LANP_FEAT_VER_DILUTION_OF_PRECISION_SUP_BIT     = COMMON_BIT(LANP_FEAT_VER_DILUTION_OF_PRECISION_SUP_POS),

    /// Location and Speed Characteristic Content Masking Supported
    LANP_FEAT_LSPEED_CHAR_CT_MASKING_SUP_POS        = 17,
    LANP_FEAT_LSPEED_CHAR_CT_MASKING_SUP_BIT        = COMMON_BIT(LANP_FEAT_LSPEED_CHAR_CT_MASKING_SUP_POS),

    /// Fix Rate Setting Supported
    LANP_FEAT_FIX_RATE_SETTING_SUP_POS              = 18,
    LANP_FEAT_FIX_RATE_SETTING_SUP_BIT              = COMMON_BIT(LANP_FEAT_FIX_RATE_SETTING_SUP_POS),

    /// Elevation Setting Supported
    LANP_FEAT_ELEVATION_SETTING_SUP_POS             = 19,
    LANP_FEAT_ELEVATION_SETTING_SUP_BIT             = COMMON_BIT(LANP_FEAT_ELEVATION_SETTING_SUP_POS),

    /// Position Status Supported
    LANP_FEAT_POSITION_STATUS_SUP_POS               = 20,
    LANP_FEAT_POSITION_STATUS_SUP_BIT               = COMMON_BIT(LANP_FEAT_POSITION_STATUS_SUP_POS),
...
enum lanp_lspeed_flags
{
    ...
    LANP_LSPEED_INST_SPEED_PRESENT_BIT          = COMMON_BIT(LANP_LSPEED_INST_SPEED_PRESENT_POS),

    /// Total Distance Present
    LANP_LSPEED_TOTAL_DISTANCE_PRESENT_POS      = 1,
    LANP_LSPEED_TOTAL_DISTANCE_PRESENT_BIT      = COMMON_BIT(LANP_LSPEED_TOTAL_DISTANCE_PRESENT_POS),

    /// Location Present
    LANP_LSPEED_LOCATION_PRESENT_POS            = 2,
    LANP_LSPEED_LOCATION_PRESENT_BIT            = COMMON_BIT(LANP_LSPEED_LOCATION_PRESENT_POS),

    /// Elevation Present
    LANP_LSPEED_ELEVATION_PRESENT_POS           = 3,
    LANP_LSPEED_ELEVATION_PRESENT_BIT           = COMMON_BIT(LANP_LSPEED_ELEVATION_PRESENT_POS),

    /// Heading Present
    LANP_LSPEED_HEADING_PRESENT_POS             = 4,
    LANP_LSPEED_HEADING_PRESENT_BIT             = COMMON_BIT(LANP_LSPEED_HEADING_PRESENT_POS),

    /// Rolling Time Present
    LANP_LSPEED_ROLLING_TIME_PRESENT_POS        = 5,
    LANP_LSPEED_ROLLING_TIME_PRESENT_BIT        = COMMON_BIT(LANP_LSPEED_ROLLING_TIME_PRESENT_POS),

    /// UTC Time Present
    LANP_LSPEED_UTC_TIME_PRESENT_POS            = 6,
    LANP_LSPEED_UTC_TIME_PRESENT_BIT            = COMMON_BIT(LANP_LSPEED_UTC_TIME_PRESENT_POS),

    /// Position Status LSB
    LANP_LSPEED_POSITION_STATUS_LSB_POS         = 7,
    LANP_LSPEED_POSITION_STATUS_LSB_BIT         = COMMON_BIT(LANP_LSPEED_POSITION_STATUS_LSB_POS),

    /// Position Status MSB
    LANP_LSPEED_POSITION_STATUS_MSB_POS         = 8,
    LANP_LSPEED_POSITION_STATUS_MSB_BIT         = COMMON_BIT(LANP_LSPEED_POSITION_STATUS_MSB_POS),

    /// Speed and Distance format
    LANP_LSPEED_SPEED_AND_DISTANCE_FORMAT_POS   = 9,
    LANP_LSPEED_SPEED_AND_DISTANCE_FORMAT_BIT   = COMMON_BIT(LANP_LSPEED_SPEED_AND_DISTANCE_FORMAT_POS),

    /// Elevation Source LSB
    LANP_LSPEED_ELEVATION_SOURCE_LSB_POS        = 10,
    LANP_LSPEED_ELEVATION_SOURCE_LSB_BIT        = COMMON_BIT(LANP_LSPEED_ELEVATION_SOURCE_LSB_POS),

    /// Elevation Source MSB
    LANP_LSPEED_ELEVATION_SOURCE_MSB_POS        = 11,
    LANP_LSPEED_ELEVATION_SOURCE_MSB_BIT        = COMMON_BIT(LANP_LSPEED_ELEVATION_SOURCE_MSB_POS),

    /// Heading Source
    LANP_LSPEED_HEADING_SOURCE_POS              = 12,
    LANP_LSPEED_HEADING_SOURCE_BIT              = COMMON_BIT(LANP_LSPEED_HEADING_SOURCE_POS),
...
enum lanp_posq_flags
{
    ...
    LANP_POSQ_NUMBER_OF_BEACONS_IN_SOLUTION_PRESENT_BIT = COMMON_BIT(LANP_POSQ_NUMBER_OF_BEACONS_IN_SOLUTION_PRESENT_POS),

    /// Number of Beacons in View Present
    LANP_POSQ_NUMBER_OF_BEACONS_IN_VIEW_PRESENT_POS     = 1,
    LANP_POSQ_NUMBER_OF_BEACONS_IN_VIEW_PRESENT_BIT     = COMMON_BIT(LANP_POSQ_NUMBER_OF_BEACONS_IN_VIEW_PRESENT_POS),

    /// Time to First Fix Present
    LANP_POSQ_TIME_TO_FIRST_FIX_PRESENT_POS             = 2,
    LANP_POSQ_TIME_TO_FIRST_FIX_PRESENT_BIT             = COMMON_BIT(LANP_POSQ_TIME_TO_FIRST_FIX_PRESENT_POS),

    /// EHPE Present
    LANP_POSQ_EHPE_PRESENT_POS                          = 3,
    LANP_POSQ_EHPE_PRESENT_BIT                          = COMMON_BIT(LANP_POSQ_EHPE_PRESENT_POS),

    /// EVPE Present
    LANP_POSQ_EVPE_PRESENT_POS                          = 4,
    LANP_POSQ_EVPE_PRESENT_BIT                          = COMMON_BIT(LANP_POSQ_EVPE_PRESENT_POS),

    /// HDOP Present
    LANP_POSQ_HDOP_PRESENT_POS                          = 5,
    LANP_POSQ_HDOP_PRESENT_BIT                          = COMMON_BIT(LANP_POSQ_HDOP_PRESENT_POS),

    /// VDOP Present
    LANP_POSQ_VDOP_PRESENT_POS                          = 6,
    LANP_POSQ_VDOP_PRESENT_BIT                          = COMMON_BIT(LANP_POSQ_VDOP_PRESENT_POS),

    /// Position Status LSB
    LANP_POSQ_POSITION_STATUS_LSB_POS                   = 7,
    LANP_POSQ_POSITION_STATUS_LSB_BIT                   = COMMON_BIT(LANP_POSQ_POSITION_STATUS_LSB_POS),

    /// Position Status MSB
    LANP_POSQ_POSITION_STATUS_MSB_POS                   = 8,
    LANP_POSQ_POSITION_STATUS_MSB_BIT                   = COMMON_BIT(LANP_POSQ_POSITION_STATUS_MSB_POS),
...
enum lanp_navi_flags
{
    ...
    LANP_NAVI_REMAINING_DIS_PRESENT_BIT             = COMMON_BIT(LANP_NAVI_REMAINING_DIS_PRESENT_POS),

    /// Remaining Vertical Distance Present
    LANP_NAVI_REMAINING_VER_DIS_PRESENT_POS         = 1,
    LANP_NAVI_REMAINING_VER_DIS_PRESENT_BIT         = COMMON_BIT(LANP_NAVI_REMAINING_VER_DIS_PRESENT_POS),

    /// Estimated Time of Arrival Present
    LANP_NAVI_ESTIMATED_TIME_OF_ARRIVAL_PRESENT_POS = 2,
    LANP_NAVI_ESTIMATED_TIME_OF_ARRIVAL_PRESENT_BIT = COMMON_BIT(LANP_NAVI_ESTIMATED_TIME_OF_ARRIVAL_PRESENT_POS),

    /// Position Status lsb
    LANP_NAVI_POSITION_STATUS_LSB_POS               = 3,
    LANP_NAVI_POSITION_STATUS_LSB_BIT               = COMMON_BIT(LANP_NAVI_POSITION_STATUS_LSB_POS),

    /// Position Status msb
    LANP_NAVI_POSITION_STATUS_MSB_POS               = 4,
    LANP_NAVI_POSITION_STATUS_MSB_BIT               = COMMON_BIT(LANP_NAVI_POSITION_STATUS_MSB_POS),

    /// Heading Source
    LANP_NAVI_HEADING_SOURCE_POS                    = 5,
    LANP_NAVI_HEADING_SOURCE_BIT                    = COMMON_BIT(LANP_NAVI_HEADING_SOURCE_POS),

    /// Navigation Indicator Type
    LANP_NAVI_NAVIGATION_INDICATOR_TYPE_POS         = 6,
    LANP_NAVI_NAVIGATION_INDICATOR_TYPE_BIT         = COMMON_BIT(LANP_NAVI_NAVIGATION_INDICATOR_TYPE_POS),

    /// Waypoint Reached
    LANP_NAVI_WAYPOINT_REACHED_POS                  = 7,
    LANP_NAVI_WAYPOINT_REACHED_BIT                  = COMMON_BIT(LANP_NAVI_WAYPOINT_REACHED_POS),

    /// Destination Reached
    LANP_NAVI_DESTINATION_REACHED_POS               = 8,
    LANP_NAVI_DESTINATION_REACHED_BIT               = COMMON_BIT(LANP_NAVI_DESTINATION_REACHED_POS),
