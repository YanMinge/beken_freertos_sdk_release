...
enum rscp_meas_flags_bf
{
    ...
    RSCP_MEAS_INST_STRIDE_LEN_PRESENT_BIT = COMMON_BIT(RSCP_MEAS_INST_STRIDE_LEN_PRESENT_POS),
    /// Total Distance Present
    /// 0 False and 1 True
    RSCP_MEAS_TOTAL_DST_MEAS_PRESENT_POS = 1,
    RSCP_MEAS_TOTAL_DST_MEAS_PRESENT_BIT = COMMON_BIT(RSCP_MEAS_TOTAL_DST_MEAS_PRESENT_POS),
    /// Walking or Running
    /// 0 Walking and 1 Running
    RSCP_MEAS_WALK_RUN_STATUS_POS = 2,
    RSCP_MEAS_WALK_RUN_STATUS_BIT = COMMON_BIT(RSCP_MEAS_WALK_RUN_STATUS_POS),
};
...
enum rscp_feat_flags_bf
{
    ...
    RSCP_FEAT_INST_STRIDE_LEN_SUPP_BIT = COMMON_BIT(RSCP_FEAT_INST_STRIDE_LEN_SUPP_POS),

    /// Total Distance Measurement Supported
    RSCP_FEAT_TOTAL_DST_MEAS_SUPP_POS = 1,
    RSCP_FEAT_TOTAL_DST_MEAS_SUPP_BIT = COMMON_BIT(RSCP_FEAT_TOTAL_DST_MEAS_SUPP_POS),

    /// Walking or Running Status Supported
    RSCP_FEAT_WALK_RUN_STATUS_SUPP_POS = 2,
    RSCP_FEAT_WALK_RUN_STATUS_SUPP_BIT = COMMON_BIT(RSCP_FEAT_WALK_RUN_STATUS_SUPP_POS),

    /// Calibration Procedure Supported
    RSCP_FEAT_CALIB_PROC_SUPP_POS = 3,
    RSCP_FEAT_CALIB_PROC_SUPP_BIT = COMMON_BIT(RSCP_FEAT_CALIB_PROC_SUPP_POS),

    /// Multiple Sensor Locations Supported
    RSCP_FEAT_MULT_SENSOR_LOC_SUPP_POS = 4,
    RSCP_FEAT_MULT_SENSOR_LOC_SUPP_BIT = COMMON_BIT(RSCP_FEAT_MULT_SENSOR_LOC_SUPP_POS),
};
