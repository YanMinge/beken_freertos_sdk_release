...
typedef struct prf_data
{
    ...
    kernel_task_desc_t        desc;
    /// Profile Task Number
    uint8_t               prf_task;
    /// Application Task Number
    uint8_t               app_task;
    #endif // (BLE_HL_MSG_API)
    /// API Identifier (@see enum TASK_BLE_API_ID)
    uint8_t               api_id;
 ...
 ****************************************************************************************
 */
kernel_task_id_t prf_src_task_get(uint8_t prf_id);
 ...
 ****************************************************************************************
 */
kernel_task_id_t prf_dst_task_get(uint8_t prf_id);

prf_data_t* prf_data_get_by_task_id(uint8_t prf_task_id);

prf_data_t* prf_data_get_by_prf_task(uint8_t prf_task);

prf_data_t* prf_data_get_by_prf_handler(uint16_t handler);
 ...
 * @return Profile API Identifier (@see enum TASK_BLE_API_ID)
 ****************************************************************************************
 */
 ...
 * (automatically update index of task in returned task id)
 *
 * @param[in] api_id Profile API Identifier (@see enum TASK_BLE_API_ID)
 * @return Task Number
 ****************************************************************************************
 */
 ...
 ****************************************************************************************
 */
void prf_pack_char_pres_fmt(common_buf_t* p_buf, const prf_char_pres_fmt_t* char_pres_fmt);
 ...
 ****************************************************************************************
 */
void prf_unpack_char_pres_fmt(common_buf_t* p_buf, prf_char_pres_fmt_t* char_pres_fmt);
 ...
 ****************************************************************************************
 */
void prf_pack_date_time(common_buf_t*p_buf, const prf_date_time_t* p_date_time);
 ...
 ****************************************************************************************
 */
void prf_pack_date(common_buf_t*p_buf, const prf_date_t* p_date);
 ...
 ****************************************************************************************
 */
void prf_unpack_date_time(common_buf_t* p_buf, prf_date_time_t* p_date_time);
 ...
 ****************************************************************************************
 */
void prf_unpack_date(common_buf_t* p_buf, prf_date_t* p_date);
 ...
 ****************************************************************************************
 */
uint8_t prf_buf_alloc(common_buf_t** pp_buf, uint16_t data_len);
 ...
 ****************************************************************************************
 */
uint16_t prf_e2e_crc(common_buf_t* p_buf);
